...
const watching =() =>{
    ...
    watch('./src/icons/**.svg', imageSVG);
    watch('./src/images/**.jpg', images);
    watch('./src/images/**.png', images);
    watch('./src/images/**.jpeg', images);
}

exports.default = series(clean, parallel(htmlBuild, favicon, scripts, fonts, images, imageSVG), stylesMin, watching);
...
exports.build = series(clean, parallel(htmlBuild, favicon, scriptsBuild, fonts, imagesBuild, imageSVG), stylesBuild);
